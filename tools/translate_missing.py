...
def collect_missing_sources(english: dict[str, str], exact_zh: dict[str, str], memory: dict) -> list[str]:
    missing: set[str] = set()
...
def _translate_batch(sources: list[str], glossary: dict, api_url: str, api_key: str, model: str) -> dict[str, str]:
    system = (
